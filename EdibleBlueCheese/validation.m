...
/*******************************
 ...
 Letters And Space Only, no number
...
-(void) MinLength: (NSInteger) length  textField: (UITextField *)textField FieldName: (NSString *) textFieldName{
    ...
    if(textField.text.length > length || textField.text.length == length){
        ...
        NSString *msg = [NSString stringWithFormat:@"%@ length should be more than %ld.",textFieldName, length];
...
-(void) MaxLength: (NSInteger) length textField: (UITextField *)textField FieldName: (NSString *) textFieldName {
    ...
    if(textField.text.length < length || textField.text.length == length) {
        ...
        NSString *msg = [NSString stringWithFormat:@"%@ length should be less than %ld.",textFieldName, length];
